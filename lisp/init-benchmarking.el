;;; init-benchmarking.el --- Measure startup and require times
;;; Commentary:
;; Credit goes to Steve Purcell
;;     https://github.com/purcell/emacs.d/blob/master/lisp/init-benchmarking.el

;; To view a list of the time it took to execute each 'require' statement, use:
;;     M-x sanityinc/require-times
;; or:
;;     M-x san
...
LOAD-DURATION is the time taken in millisecods to load FEATURE.")
